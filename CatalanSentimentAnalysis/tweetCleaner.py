...
class TweetCleaner:
    ...
    def _read_stopwords(self):
        ...
        """
        self.stopwords = []
        with open('./CatalanSentimentAnalysis/data/cat_stopwords.txt', 'r') as f:
    ...
    def _read_senticon(self):
        ...
        """
        root = ET.parse('./CatalanSentimentAnalysis/data/senticon.ca.xml').getroot()
        self.senticon_words = []
    ...
    def _read_dict(self):
        ...
        self.values = []
        self.key = ''
        with open('./CatalanSentimentAnalysis/data/cat_dict_sinonims.dat', 'r') as f:
            for line in f.readlines():
                if line.startswith('-|'):
